...
dataset = read.csv("C:\\Users\\Sai\\Desktop\\My ML\\problem-2-missingvalues\\dataset1\\MissingData2.csv",header=FALSE)
...
write.table(completeData1, "induriMissingResult2.txt", sep="\t")